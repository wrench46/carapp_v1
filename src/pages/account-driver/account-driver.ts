...
/**
 * Generated class for the AccountDriverPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-account-driver',
  templateUrl: 'account-driver.html',
})
export class AccountDriverPage {
...
//alert(JSON.stringify(this.userdetails));
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AccountDriverPage');
  }
